...
media: []
color_hex: '#77A846'
subtitle: The Dryad’s Bridge
summary: "the dryad’s tree lies fallen across the stream, leaving the dryad mad and ravenous."
terrain: oak-forest
---
![](/media/3205.png)Here, not far from Olmstead Keep ([31.04](/wiki/31-04/)) lies a stream that rushes down from the [Grey Mountains](/wiki/grey-mountains/) to pour into the [Witchwater](/wiki/the-witchwater/). It is spanned by a great fallen tree that is the home of a [dryad](/wiki/dryads/). The tree just barely hangs to life and its hollow-eyed dryad sustains it by eating ravenously. Usually the dryad can be dealt with by giving her bribes in the form of food, enough of which will even induce her to allow travellers to use her tree as a bridge. However, if she is especially hungry she may attack.
