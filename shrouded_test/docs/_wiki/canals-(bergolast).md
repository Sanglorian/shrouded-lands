...
Mostly surviving is the canal that linked [Hyfalls](/wiki/hyfalls/) and Bergolast. In most parts, it is raised two metres off of the ground. Travellers that avoid the hyena packs by using the canal find they have only two directions to run when the rogue Nekh One-Wing swoops down from the sky.
