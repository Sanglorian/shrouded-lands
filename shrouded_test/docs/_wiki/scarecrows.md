...
- Category:Scarecrows
media: []
image: JohnRNeill7.png
---
|thumb|400px|An aging Scarecrow.]]
...
There are Scarecrows’ nests even in the Kingswood. Each has a single entrance marked with a rod of hawthorn ([38.06](/wiki/38-06/)), past which the elves will not pass. However, if the elves realise that the nest is inhabited they will do what they can to cause strife to those inside—perhaps leaving a beehive poised above the threshold or leading a bear to the cave.
