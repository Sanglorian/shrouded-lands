...
media: []
---
:Amelar is also known as the **Hierophant of Constant Sorrow**. There is also a figure known only as the [[Knight of Constant Sorrow]]. There are a number of other [[Hierophant]]s in the Shrouded Lands.

Amelar is mistress of the Garden of Amelar ([[36.04]]).
