...
image: 360401.png
---
: Amelar is also known as the **Hierophant of Constant Sorrow**. There is also a figure known only as the Knight of Constant Sorrow. There are a number of other [Hierophant](/wiki/hierophant/)s in the Shrouded Lands.
...
![400px](/media/360402.png)It is not the passing of years that age a man but the worries and cares that accumulate with each passing day. Perhaps it is elven frivolity and their famous lack of empathy or others that explains why an elf may live a thousand years and never age.
...
## Connection:
* It is rumored that the Ferryman ([35.06](/wiki/35-06/)) once took on tragic memories much like the Hierophant currently does. So many that he has aged into a creature more wraith than elf but still lives, for no elf ever dies of old age. That this has to do with fingers specifically nobody knows.
