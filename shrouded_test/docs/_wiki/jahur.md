...
two faces ([19.31.03](/wiki/19-31/)). As god who allegedly sees
...
enhances bucket kelp hallucinations ([19.31.04](/wiki/19-31/)).
...
The [Duke](/wiki/duke-of-thring/) fights with such a sword, an heirloom used ever since [Broderick](/wiki/broderick/)’s sword Caledbrand became animated by that unfortunate ghost.
