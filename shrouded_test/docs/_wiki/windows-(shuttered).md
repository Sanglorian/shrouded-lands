...
Yet even these distances paled in comparison to those travelled by those who visited from the outer planes. In those days the ethereal realm was more permeable - it was possible to push through into other worlds, and for other worlds to push back. There were processions of [Nephilium](/wiki/nephilium/) from the [Holy Mountain](/wiki/holy-mountain/), mighty [Galloons](/wiki/galloons/) from the [Forest of Fancy](/wiki/forest-of-fancy/), and ashen-skinned [voidsailors](/wiki/voidsailors/) from the [no-place](/wiki/no-place/), which is no place at all. The world has changed since then, though, and if the outer planes still exist, they are not reachable by any known means. Rumors abound that [Severard](/wiki/severard/) of the Seven Chins ([13.08](/wiki/13-08/)) is not dead and has found a way to travel the planes again, but this is nothing more than hearsay.
